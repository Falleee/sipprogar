...
class Login_model extends CI_Model
{
     ...
     * @param string $nip : This is nip of the user
     * @param string $password : This is encrypted password of the user
     */
    function loginMe($nip, $password)
    {
        $this->db->select('BaseTbl.nip, BaseTbl.password, BaseTbl.nama, BaseTbl.roleId, Roles.role , BaseTbl.id_jabatan , Jabatan.nama_jabatan');
        $this->db->from('tbl_users as BaseTbl');
        $this->db->join('tbl_roles as Roles','Roles.roleId = BaseTbl.roleId');
        $this->db->join('tbl_jabatan as Jabatan','Jabatan.id_jabatan = BaseTbl.id_jabatan');
